...
class MediaController
{
    ...
    /**
     * Obtener TODOS los hashes MD5 del dispositivo almacenados en el servidor.
     * Usado por la app móvil para detectar qué archivos ya están subidos.
     * Responde rápido: solo devuelve los hashes, no los datos completos.
     */
    public function getAllHashes(): array
    {
        $result = $this->db->query("
            SELECT device_file_hash
            FROM media
            WHERE device_file_hash IS NOT NULL
        ");
        ...
        return ['success' => true, 'data' => $hashes, 'count' => count($hashes)];
    }
